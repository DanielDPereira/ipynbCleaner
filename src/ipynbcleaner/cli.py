...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("output", nargs="?", type=Path, help="Destination file. Defaults to *_clean.ipynb.")
    parser.add_argument("--drop-outputs", action="store_true", help="Remove all outputs from code cells.")
    parser.add_argument("--keep-execution-count", action="store_true", help="Keep execution counts.")
    parser.add_argument("--keep-root-metadata", action="store_true", help="Preserve notebook-level metadata.")
    parser.add_argument("--keep-cell-metadata", action="store_true", help="Preserve per-cell metadata.")
    parser.add_argument("--keep-cell-ids", action="store_true", help="Preserve Jupyter cell IDs.")
    parser.add_argument("--keep-attachments", action="store_true", help="Preserve cell attachments.")
